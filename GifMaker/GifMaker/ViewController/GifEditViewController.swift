...
class GifEditViewController: UIViewController {
    ...
    @IBAction func saveButtonTapped(_ sender: Any) {
        ...
        gifController?.createNewGif(name: text, fileURL: self.tempGifURL, completion: {
...
//            finalTextFieldPoint = textField.frame.origin
...
//        guard let images = images, let text = textField.text else { return }
...
//            self.createAndSaveNewGif(url: url, completion: {
//                completion()
//            })
//
//        }
